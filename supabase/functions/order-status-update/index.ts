...
const handler = async (req: Request): Promise<Response> => {
  ...
  const rlKey = getRateLimitKey(req, 'order-status');
  ...
  try {
    ...
    console.error("Error in order-status-update function:", error);
    return new Response(
      JSON.stringify({ error: "Erreur lors de l'envoi de la mise à jour de commande" }),
