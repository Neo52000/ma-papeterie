...
export default function AdminPricing() {
  ...
  if (showForm) {
    return (
      <AdminLayout 
        title={editingRule ? 'Modifier la règle' : 'Nouvelle règle de pricing'} 
        description="Configuration des règles de tarification automatique"
      >
        <PricingRuleForm
  ...
  return (
    <AdminLayout 
      ...
      description="Gérez les règles pour ajuster automatiquement les prix"
    >
