...
const categoryImages: Record<string, string> = {
  "CONSOMMABLES": imgConsommables.src,
  "ECRIRE ET CORRIGER": imgEcrire.src,
  "JEUX": imgJeux.src,
  "CONSOMMABLES INFORMATIQUES": imgConsoInfo.src,
  "CLASSEMENT": imgClassement.src,
  "PEINTURE": imgPeinture.src,
  "CAHIERS ET DERIVES DE PAPIER": imgCahiers.src,
  "CAHIERS": imgCahiers.src,
  "CAHIERS SCOLAIRES": imgCahiersScolaires.src,
  "CAHIERS DE BUREAU": imgCahiers.src,
  ...
  "CHEMISES": imgChemises.src,
  "MARQUEURS": imgMarqueurs.src,
  ...
  "HYGIENE": imgHygiene.src,
  "UNIVERS PETITE ENFANCE": imgPetiteEnfance.src,
  "BUREAUTIQUE": imgBureautique.src,
  "PAPIERS": imgPapiers.src,
  "ETIQUETTES": imgEtiquettes.src,
  "COLORIAGE": imgColoriage.src,
  "CLASSEURS": imgClasseurs.src,
  "PRODUITS POUR DECORER": imgDecoration.src,
  "ROLLERS ET STYLOS": imgRollersStylos.src,
  "EMBALLAGE": imgEmballage.src,
  "INFORMATIQUE": imgInformatique.src,
  "STYLOS-BILLES": imgStylosBilles.src,
};
