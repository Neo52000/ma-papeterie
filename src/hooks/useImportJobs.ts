...
export const IMPORT_FIELDS = [
  ...
  { key: "manufacturer_code", label: "Code fabricant",             required: false },
  { key: "description",       label: "Description",                required: false },
  { key: "category",          label: "Catégorie",                  required: false },
  { key: "subcategory",       label: "Sous-catégorie",             required: false },
  { key: "family",            label: "Famille",                    required: false },
  { key: "subfamily",         label: "Sous-famille",               required: false },
  ...
  { key: "cost_price",        label: "Prix d'achat HT (€)",        required: false },
  { key: "eco_tax",           label: "Éco-taxe (€)",               required: false },
  ...
  { key: "dimensions_cm",     label: "Dimensions (cm)",            required: false },
  { key: "country_origin",    label: "Pays d'origine",             required: false },
  { key: "supplier_reference",label: "Réf. fournisseur",           required: false },
  { key: "supplier_price",    label: "Prix fournisseur HT (€)",    required: false },
  { key: "min_order_qty",     label: "Qté minimum commande",       required: false },
  { key: "delivery_days",     label: "Délai livraison (jours)",    required: false },
] as const;
...
export function autoDetectMapping(headers: string[]): Record<string, string> {
  ...
  const ALIASES: Record<ImportFieldKey, string[]> = {
    ...
    manufacturer_code:  ["code fabricant", "manufacturer code", "maker code"],
    description:        ["description", "desc", "détail", "detail"],
    category:           ["catégorie", "categorie", "category", "rayon"],
    subcategory:        ["sous-catégorie", "sous categorie", "subcategory", "sub-category"],
    family:             ["famille", "family"],
    subfamily:          ["sous-famille", "sous famille", "subfamily", "sub-family"],
    ...
    cost_price:         ["prix achat ht", "cost price", "prix revient", "prix de revient"],
    eco_tax:            ["éco-taxe", "eco taxe", "eco tax", "ecotaxe", "deee"],
    ...
    dimensions_cm:      ["dimensions", "dim", "taille", "size", "l x l x h"],
    country_origin:     ["pays", "country", "origine", "pays d'origine", "country of origin"],
    ...
    min_order_qty:      ["qté min", "qty min", "minimum", "moq", "min order"],
    delivery_days:      ["délai", "delai", "delivery", "lead time", "jours livraison"],
  };
